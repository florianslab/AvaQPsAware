...
function newAliens(arrayOfColorPairs, id) {
    ...
    var bigAlien = {left: -10, top: 70, width: 80, height:80},     // The relative position and size of each bigAlien
        bubble = {left: 0, top: 0, width: 61, height: 69},      // The relative position and size of each bubble
        miniAlien = {left: 10, top: 5, width: 40, height: 40};  // The relative position and size of each miniAlien
    
    var xoffset = -20; // The number of pixels separating each bigAlien
